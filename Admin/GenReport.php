...
if (!isset($_SESSION["admin_session"])) {
  ...
  if (isset($_GET['vendoryear'])) {
    $year = $_GET['vendoryear'];
  }
  $month = 1;
  if (isset($_GET['vendormonth'])) {
    $month = $_GET['vendormonth'];
  }
    ...
    <div class="container-scroller">
      ...
      <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
          <a class="navbar-brand brand-logo mr-5" href="./admin_dash.php"><img src="../images/logo.svg" class="mr-2" alt="logo" /></a>
          ...
          <div class="content-wrapper">
            ...
            <div class="row" style="margin-top: 20px;">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <form method="" style="display: flex; flex-direction: column">
                      <a class="btn btn-success" style="margin-bottom: 20px; background-color: #4B49AC" href="getmonthinvoice.php?month=<?= $month ?>&year=<?= $year ?>">GET INVOICE RECORD OF THE MONTH</a>
